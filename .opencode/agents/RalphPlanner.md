...
**@RalphCoordinator will parse any format** - use what fits your project.
...
4. Offer to invoke @RalphCoordinator to begin autonomous execution
5. Let user review before starting the loop
...
6. Offer to invoke @RalphCoordinator to begin execution
